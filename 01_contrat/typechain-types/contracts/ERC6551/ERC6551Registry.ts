...
export interface ERC6551RegistryInterface extends utils.Interface {
  functions: {
    ...
    "lootDefault()": FunctionFragment;
    "lootNft()": FunctionFragment;
    "setLootDefault(address)": FunctionFragment;
    "setLootNft(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "lootDefault",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "lootNft", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "setLootDefault",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "setLootNft",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "setLootNft", data: BytesLike): Result;
...
export interface ERC6551Registry extends BaseContract {
  ...
  functions: {
    ...
    lootDefault(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    lootDefault(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    lootDefault(overrides?: CallOverrides): Promise<PopulatedTransaction>;
