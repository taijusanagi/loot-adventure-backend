...
export interface SampleLootV2Interface extends utils.Interface {
  functions: {
    ...
    "safeMintTemp(address,uint256,uint16,uint16,uint16,uint16,uint16,uint16,uint16[6],uint8[4],uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[])": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "lootV1", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "lootV1", data: BytesLike): Result;
...
export interface SampleLootV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SampleLootV2Interface;
  ...
  functions: {
    ...
    lootV1(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    lootV1(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    lootV1(overrides?: CallOverrides): Promise<PopulatedTransaction>;
