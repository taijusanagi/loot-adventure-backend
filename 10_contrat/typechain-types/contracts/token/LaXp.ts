...
export interface LaXpInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "burnXp(address,uint256,string)": EventFragment;
    "getXp(address,uint256,string)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "burnXp"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "getXp"): EventFragment;
}
...
export interface burnXpEventObject {
  to_: string;
  amount_: BigNumber;
  source_: string;
}
export type burnXpEvent = TypedEvent<
  [string, BigNumber, string],
  burnXpEventObject
>;

export type burnXpEventFilter = TypedEventFilter<burnXpEvent>;

export interface getXpEventObject {
  to_: string;
  amount_: BigNumber;
  source_: string;
}
export type getXpEvent = TypedEvent<
  [string, BigNumber, string],
  getXpEventObject
>;

export type getXpEventFilter = TypedEventFilter<getXpEvent>;

export interface LaXp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LaXpInterface;
  ...
  filters: {
    ...
    "burnXp(address,uint256,string)"(
      to_?: null,
      amount_?: null,
      source_?: null
    ): burnXpEventFilter;
    burnXp(to_?: null, amount_?: null, source_?: null): burnXpEventFilter;

    "getXp(address,uint256,string)"(
      to_?: null,
      amount_?: null,
      source_?: null
    ): getXpEventFilter;
    getXp(to_?: null, amount_?: null, source_?: null): getXpEventFilter;
  };
