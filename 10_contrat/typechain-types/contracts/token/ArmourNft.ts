...
export interface ArmourNftInterface extends utils.Interface {
  functions: {
    ...
    "getArmourName(uint256)": FunctionFragment;
    "getArmourSeed(uint256)": FunctionFragment;
    "getArmourType(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getArmourName",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getArmourSeed",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getArmourType",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface ArmourNft extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArmourNftInterface;
